                        ...
                        <div class=" w_auto p-5 active">
                            <div class="border border-gray-200 dark:border-dark-5 rounded-md p-5">
                                ...
                                <div class="mt-3">
                                    ...
                                    <x-jet-input-error for="new_video" class="mt-2" />
                                </div>
                                <div class="mt-3"> 
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="border-2 border-dashed shadow-sm border-gray-200 dark:border-dark-5 rounded-md p-5 mt-3">
                                        <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                            @if ($new_banner_left)
                                            <img class="rounded-md" alt="" src="{{ $new_banner_left->temporaryUrl() }}">
                                            @else 
                                            <img class="rounded-md" alt="" src="{{ asset('images/'.$banner_left) }}">
                                            @endif
                                        </div>
                                        <div class="mx-auto cursor-pointer relative mt-5">
                                            <button type="button" class="btn btn-primary w-full">Edit Banner Left</button>
                                            <input type="file" class="w-full h-full top-0 left-0 absolute opacity-0" wire:model="new_banner_left">
                                        </div>
                                        <div class="form-help">banner Left Size 1000px X 400px</div>
                                        <x-jet-input-error for="new_banner_left" class="mt-2" />
                                    </div>
                                </div>
                                <div class="mt-3"> 
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="border-2 border-dashed shadow-sm border-gray-200 dark:border-dark-5 rounded-md p-5 mt-3">
                                        <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                            @if ($new_banner_right)
                                            <img class="rounded-md" alt="" src="{{ $new_banner_right->temporaryUrl() }}">
                                            @else 
                                            <img class="rounded-md" alt="" src="{{ asset('images/'.$banner_right) }}">
                                            @endif
                                        </div>
                                        <div class="mx-auto cursor-pointer relative mt-5">
                                            <button type="button" class="btn btn-primary w-full">Edit Banner Right</button>
                                            <input type="file" class="w-full h-full top-0 left-0 absolute opacity-0" wire:model="new_banner_right">
                                        </div>
                                        <div class="form-help">banner Right Size 1000px X 400px</div>
                                        <x-jet-input-error for="new_banner_right" class="mt-2" />
                                    </div>
                                </div>
                                <div class="mt-3"> 
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="border-2 border-dashed shadow-sm border-gray-200 dark:border-dark-5 rounded-md p-5 mt-3">
                                        <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                            @if ($new_denah_image)
                                            <img class="rounded-md" alt="" src="{{ $new_denah_image->temporaryUrl() }}">
                                            @else 
                                            <img class="rounded-md" alt="" src="{{ asset('images/'.$denah_image) }}">
                                            @endif
                                        </div>
                                        <div class="mx-auto cursor-pointer relative mt-5">
                                            <button type="button" class="btn btn-primary w-full">Add Denah Image</button>
                                            <input type="file" class="w-full h-full top-0 left-0 absolute opacity-0" wire:model="new_denah_image">
                                        </div>
                                        <x-jet-input-error for="new_denah_image" class="mt-2" />
                                    </div>
                                </div>
