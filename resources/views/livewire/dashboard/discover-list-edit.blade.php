                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="border-2 border-dashed shadow-sm border-gray-200 dark:border-dark-5 rounded-md p-5">
                                        <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                            <img class="rounded-md" alt="Rubick Tailwind HTML Admin Template" src="/images/discover/{{ $image }}">
                                        </div>
                                        <div class="mx-auto cursor-pointer relative mt-5">
                                            <button type="button" class="btn btn-primary w-full" wire:click="deleteimage('image')"> Delete Cover & Change Cover</button>
                                        </div>
                                    </div>
                                    @else
                                    <x-input.filepond wire:model="new_image" />
                                    @endif
                                    {{-- <div class="form-help">Image Size  </div> --}}
                                    <x-jet-input-error for="new_image" class="mt-2" />
                                </div>
                            </div>
                        </div>
                    </div>
