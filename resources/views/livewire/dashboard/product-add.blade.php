                            ...
                            <div class="border border-gray-200 dark:border-dark-5 rounded-md p-5">
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="border-2 border-dashed shadow-sm border-gray-200 dark:border-dark-5 rounded-md p-5 mt-3">
                                        <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                            @if ($denah)
                                            <img class="rounded-md" alt="" src="{{ $denah->temporaryUrl() }}">
                                            @endif
                                        </div>
                                        <div class="mx-auto cursor-pointer relative mt-5">
                                            <button type="button" class="btn btn-primary w-full">Add Denah Image</button>
                                            <input type="file" class="w-full h-full top-0 left-0 absolute opacity-0" wire:model="denah">
                                        </div>
                                        {{-- <div class="form-help">Denah Image Size 1000px X 400px</div> --}}
                                        <x-jet-input-error for="denah" class="mt-2" />
                                    </div>
                                </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="border-2 border-dashed shadow-sm border-gray-200 dark:border-dark-5 rounded-md p-5 mt-3">
                                        <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                            @if ($denah2)
                                            <img class="rounded-md" alt="" src="{{ $denah2->temporaryUrl() }}">
                                            @endif
                                        </div>
                                        <div class="mx-auto cursor-pointer relative mt-5">
                                            <button type="button" class="btn btn-primary w-full">Add Denah Image 2</button>
                                            <input type="file" class="w-full h-full top-0 left-0 absolute opacity-0" wire:model="denah2">
                                        </div>
                                        <div class="form-help">NOTE : Denah Image 2 Optional</div>
                                        <x-jet-input-error for="denah2" class="mt-2" />
                                    </div>
                                </div>
