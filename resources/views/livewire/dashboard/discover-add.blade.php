                    ...
                    <div class="post__content tab-content">
                        <div class=" w_auto p-5 active">
                            <div class="border border-gray-200 dark:border-dark-5 rounded-md p-5">
                                ...
                                <div class="mt-3"> 
                                    <label for="discover_title" class="form-label">title Discover</label> 
                                    <input id="discover_title" type="text" class="form-control" placeholder="discover" wire:model="discover_title"> 
                                    <div class="form-help">Maximum 200 characters</div>
                                    <x-jet-input-error for="discover_title" class="mt-2" />
                                </div>
                                <div class="mt-3"> 
